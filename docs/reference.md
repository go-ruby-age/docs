...
The public API lives at the module root (`github.com/go-ruby-age/age`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `age`, while the surface follows
...
```go
import "github.com/go-ruby-age/age"
```
...
- **[pkg.go.dev/github.com/go-ruby-age/age](https://pkg.go.dev/github.com/go-ruby-age/age)**

The module's [README](https://github.com/go-ruby-age/age#readme) carries worked
