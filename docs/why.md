...
`go-ruby-age/age` reimplements Ruby's `age` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-age/age` directly, with no Ruby runtime;
