...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `age`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`age`](https://github.com/go-ruby-age/age) | the library — Ruby's `age` in pure Go |
| [`docs`](https://github.com/go-ruby-age/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-age.github.io`](https://github.com/go-ruby-age/go-ruby-age.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-age/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-age/age](https://github.com/go-ruby-age/age).
